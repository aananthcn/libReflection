...
| [0016](0016-declaration-level-class-hash.md) | `DeclHash`: a declaration-level, ABI-independent hash alongside `ClassHash`, scoped to later enable external wire-format interop | **Implemented** — see `tests/test_decl_hash.cpp` |
